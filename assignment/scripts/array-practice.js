...
let favoriteFoods = ['tagine', 'cesar salad', 'mashed potatoes', 'birria tacos'];
...
console.log('Added a new favorite food to the end', favoriteFoods);
...
favoriteFoods.unshift('cheesecake');
...
combinedArray = animalArray.concat (favoriteFoods);
